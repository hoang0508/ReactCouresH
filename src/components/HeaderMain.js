    ...
    <div className="flex items-center justify-center p-4 bg-white shadow-md">
      ...
      <div className="ml-auto mr-5 flex items-center gap-5">
        <span className="relative w-8">
          ...
          <span className="w-5 h-5 rounded-full flex items-center justify-center text-white bg-pink-600 text-sm absolute top-0 right-0 translate-x-2/4">
            {cartItemsCount || 0}
          </span>
        </span>
        <span className="relative w-8">
      ...
      <button
        className="p-3 ml-auto text-black bg-gray-400 rounded-lg"
